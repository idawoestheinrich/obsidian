...
17. The format for change is: `c [number] motion`
...
34.  Type  `:help`   to open a help window. 
...
39. When typing a  `:  command`, press `CTRL-D` to see possible completions. 
